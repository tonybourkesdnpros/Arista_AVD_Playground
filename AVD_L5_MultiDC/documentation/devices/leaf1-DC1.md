...
| --------- | --------------- | ------------ | --------- |
| dc1_mlag1 | Vlan4094 | 10.255.252.1 | Port-Channel1 |
...
| Ethernet6 | host1-DC1_Ethernet1 | *access | *10 | *- | *- | 6 |
| Ethernet7 | host1-DC1_Ethernet2 | *access | *10 | *- | *- | 6 |
...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet3 | P2P_LINK_TO_SPINE1-DC1_Ethernet2 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2-DC1_Ethernet2 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3-DC1_Ethernet2 | routed | - | - | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet6
   description host1-DC1_Ethernet1
   no shutdown
   channel-group 6 mode active
!
interface Ethernet7
   description host1-DC1_Ethernet2
   no shutdown
   channel-group 6 mode active
```
...
| Port-Channel6 | host1-DC1_PortChannel host1-DC1 | switched | access | 10 | - | - | - | - | 6 | - |
...
interface Port-Channel6
   description host1-DC1_PortChannel host1-DC1
   no shutdown
   switchport
...
| Vlan3009 | VRF_A | MLAG-IPv4-UNDERLAY-PEER | 65101 | - |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF_A | 192.168.101.1:10 | 10:10 | - | - | learned | 10,20 |
