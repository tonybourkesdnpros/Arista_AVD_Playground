...
| Ethernet7 | host1_Ethernet2 | *access | *10 | *- | *- | 6 |
...
| Port-Channel6 | host1_PortChannel host1 | switched | access | 10 | - | - | - | - | 6 | - |
...
| Loopback99 | VRF_A_VTEP_DIAGNOSTICS | VRF_A | 10.255.1.1/32 |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF_A | 192.168.101.1:10 | 10:10 | - | - | learned | 130-131 |
...
```eos
!
ip address virtual source-nat vrf VRF_A address 10.255.1.1
```
