...
| Ethernet6 | host2_Ethernet3 | *access | *20 | *- | *- | 6 |
| Ethernet7 | host2_Ethernet4 | *access | *20 | *- | *- | 6 |
...
| Loopback99 | VRF_A_VTEP_DIAGNOSTICS | VRF_A | 10.255.1.4/32 |
...
| ----------------- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ | ----- |
| VRF_A | 192.168.101.4:10 | 10:10 | - | - | learned | 130-131 |

### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute | EVPN Multicast |
| --- | ------------------- | ------------ | -------------- |
| VRF_A | 192.168.101.4:10 | connected | IPv4: True<br>Transit: False |
...
```eos
!
ip address virtual source-nat vrf VRF_A address 10.255.1.4
```
