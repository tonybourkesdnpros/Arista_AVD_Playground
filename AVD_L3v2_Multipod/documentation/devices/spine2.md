...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet3 | P2P_LINK_TO_LEAF1_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet4 | P2P_LINK_TO_LEAF2_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet7 | P2P_LINK_TO_SUPERSPINE1_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet8 | P2P_LINK_TO_SUPERSPINE2_Ethernet4 | routed | - | - | default | 1500 | False | - | - | - | - |
...
!
interface Ethernet7
   description P2P_LINK_TO_SUPERSPINE1_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ipv6 enable
!
interface Ethernet8
   description P2P_LINK_TO_SUPERSPINE2_Ethernet4
   no shutdown
   mtu 1500
   no switchport
   ipv6 enable
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | EVPN_Overlay_Peering | default | 2011:db8::c/128 |
...
| 2011:db8::1 | 65101 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - |
| 2011:db8::2 | 65101 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - |
...
| Ethernet4 | default | IPv4-UNDERLAY-PEERS | 65101 | - |
