...
| --------- | ----------- | ---- | --------------| ------------ | --- | --- | -------- | -------------- | -------------------| ----------- | ------------ |
| Ethernet2 | P2P_LINK_TO_LEAF1-DC1_Ethernet5 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet3 | P2P_LINK_TO_LEAF2-DC1_Ethernet5 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet4 | P2P_LINK_TO_LEAF3-DC1_Ethernet5 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet5 | P2P_LINK_TO_LEAF4-DC1_Ethernet5 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet6 | P2P_LINK_TO_BORDERLEAF1-DC1_Ethernet5 | routed | - | - | default | 1500 | False | - | - | - | - |
| Ethernet7 | P2P_LINK_TO_BORDERLEAF2-DC1_Ethernet5 | routed | - | - | default | 1500 | False | - | - | - | - |
...
| --------- | ----------- | --- | ------------ |
| Loopback0 | EVPN_Overlay_Peering | default | 2001:db8:1::d/128 |
...
| 192.168.101.5 | 65105 | default | - | Inherited from peer group EVPN-OVERLAY-PEERS | Inherited from peer group EVPN-OVERLAY-PEERS | - | Inherited from peer group EVPN-OVERLAY-PEERS | - |
...
| Ethernet6 | default | IPv4-UNDERLAY-PEERS | 65105 | - |
| Ethernet7 | default | IPv4-UNDERLAY-PEERS | 65105 | - |
...
router bgp 65100
   ...
   neighbor interface Ethernet6 peer-group IPv4-UNDERLAY-PEERS remote-as 65105
   neighbor interface Ethernet7 peer-group IPv4-UNDERLAY-PEERS remote-as 65105
   ...
   neighbor 192.168.101.5 remote-as 65105
