...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet5 | routed | - | 192.168.0.25/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet5 | routed | - | 192.168.0.27/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet5 | routed | - | 192.168.0.29/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet5 | routed | - | 192.168.0.31/31 | default | 1500 | False | - | - |
| Ethernet7 | P2P_LINK_TO_SPINE5_Ethernet5 | routed | - | 192.168.0.33/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_SPINE6_Ethernet5 | routed | - | 192.168.0.35/31 | default | 1500 | False | - | - |
...
!
interface Ethernet7
   description P2P_LINK_TO_SPINE5_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_LINK_TO_SPINE6_Ethernet5
   no shutdown
   mtu 1500
   no switchport
...
| 192.168.0.24 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.26 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.28 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.30 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.32 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.34 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65299
   ...
   neighbor 192.168.0.24 description spine1_Ethernet5
   neighbor 192.168.0.26 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.26 remote-as 65001
   neighbor 192.168.0.26 description spine2_Ethernet5
   neighbor 192.168.0.28 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.28 remote-as 65001
   neighbor 192.168.0.28 description spine3_Ethernet5
   neighbor 192.168.0.30 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.30 remote-as 65001
   neighbor 192.168.0.30 description spine4_Ethernet5
   neighbor 192.168.0.32 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.32 remote-as 65001
   neighbor 192.168.0.32 description spine5_Ethernet5
   neighbor 192.168.0.34 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.34 remote-as 65001
   neighbor 192.168.0.34 description spine6_Ethernet5
