...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet3 | routed | - | 192.168.0.1/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet3 | routed | - | 192.168.0.3/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet3 | routed | - | 192.168.0.5/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet3 | routed | - | 192.168.0.7/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_SPINE6_Ethernet3 | routed | - | 192.168.0.11/31 | default | 1500 | False | - | - |
...
!
interface Ethernet8
   description P2P_LINK_TO_SPINE6_Ethernet3
   no shutdown
   mtu 1500
   no switchport
...
| 192.168.0.0 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.2 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.4 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.6 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.8 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.10 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 192.168.0.0 description spine1_Ethernet3
   neighbor 192.168.0.2 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.2 remote-as 65001
   neighbor 192.168.0.2 description spine2_Ethernet3
   neighbor 192.168.0.4 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.4 remote-as 65001
   neighbor 192.168.0.4 description spine3_Ethernet3
   neighbor 192.168.0.6 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.6 remote-as 65001
   neighbor 192.168.0.6 description spine4_Ethernet3
   neighbor 192.168.0.8 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.8 remote-as 65001
   neighbor 192.168.0.8 description spine5_Ethernet3
   neighbor 192.168.0.10 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.10 remote-as 65001
   neighbor 192.168.0.10 description spine6_Ethernet3
