...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet6 | routed | - | 192.168.0.37/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet6 | routed | - | 192.168.0.39/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet6 | routed | - | 192.168.0.41/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet6 | routed | - | 192.168.0.43/31 | default | 1500 | False | - | - |
| Ethernet7 | P2P_LINK_TO_SPINE5_Ethernet6 | routed | - | 192.168.0.45/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_SPINE6_Ethernet6 | routed | - | 192.168.0.47/31 | default | 1500 | False | - | - |
...
!
interface Ethernet7
   description P2P_LINK_TO_SPINE5_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_LINK_TO_SPINE6_Ethernet6
   no shutdown
   mtu 1500
   no switchport
...
| 192.168.0.36 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.38 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.40 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.42 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.44 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.46 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65299
   ...
   neighbor 192.168.0.36 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.36 remote-as 65001
   neighbor 192.168.0.36 description spine1_Ethernet6
   neighbor 192.168.0.38 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.38 remote-as 65001
   neighbor 192.168.0.38 description spine2_Ethernet6
   neighbor 192.168.0.40 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.40 remote-as 65001
   neighbor 192.168.0.40 description spine3_Ethernet6
   neighbor 192.168.0.42 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.42 remote-as 65001
   neighbor 192.168.0.42 description spine4_Ethernet6
   neighbor 192.168.0.44 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.44 remote-as 65001
   neighbor 192.168.0.44 description spine5_Ethernet6
   neighbor 192.168.0.46 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.46 remote-as 65001
   neighbor 192.168.0.46 description spine6_Ethernet6
