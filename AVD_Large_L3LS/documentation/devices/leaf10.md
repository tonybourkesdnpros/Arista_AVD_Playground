...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.0.110 | 192.168.0.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet12 | routed | - | 192.168.0.109/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet12 | routed | - | 192.168.0.111/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet12 | routed | - | 192.168.0.113/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet12 | routed | - | 192.168.0.115/31 | default | 1500 | False | - | - |
| Ethernet7 | P2P_LINK_TO_SPINE5_Ethernet12 | routed | - | 192.168.0.117/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_SPINE6_Ethernet12 | routed | - | 192.168.0.119/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_SPINE1_Ethernet12
   no shutdown
   mtu 1500
   no switchport
   ip address 192.168.0.109/31
!
interface Ethernet4
   description P2P_LINK_TO_SPINE2_Ethernet12
   no shutdown
   mtu 1500
   no switchport
   ip address 192.168.0.111/31
!
interface Ethernet5
   description P2P_LINK_TO_SPINE3_Ethernet12
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_SPINE4_Ethernet12
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet7
   description P2P_LINK_TO_SPINE5_Ethernet12
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_LINK_TO_SPINE6_Ethernet12
   no shutdown
   mtu 1500
   no switchport
...
| --------- | ----------- | --- | ---------- |
| Loopback0 | EVPN_Overlay_Peering | default | 192.168.101.10/32 |
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.102.10/32 |
...
interface Loopback0
   ...
   no shutdown
   ip address 192.168.101.10/32
!
interface Loopback1
   description VTEP_VXLAN_Tunnel_Source
   no shutdown
   ip address 192.168.102.10/32
```
...
| -------- | --------- | --- | -------- | -------------- | -------------- | ---------- | --- | --------------------- | ---------------------- | ------- |
| 192.168.0.108 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.110 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.101.10:10010 | 10010:10010 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_A | 192.168.101.10:10 | connected |
...
router bgp 65109
   ...
   neighbor 192.168.0.108 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.108 remote-as 65001
   neighbor 192.168.0.108 description spine1_Ethernet12
   neighbor 192.168.0.110 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.110 remote-as 65001
   neighbor 192.168.0.110 description spine2_Ethernet12
   neighbor 192.168.0.112 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.112 remote-as 65001
   neighbor 192.168.0.112 description spine3_Ethernet12
   neighbor 192.168.0.114 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.114 remote-as 65001
   neighbor 192.168.0.114 description spine4_Ethernet12
   neighbor 192.168.0.116 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.116 remote-as 65001
   neighbor 192.168.0.116 description spine5_Ethernet12
   neighbor 192.168.0.118 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.118 remote-as 65001
   neighbor 192.168.0.118 description spine6_Ethernet12
