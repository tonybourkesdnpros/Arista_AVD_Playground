...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.0.111 | 192.168.0.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet13 | routed | - | 192.168.0.121/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet13 | routed | - | 192.168.0.123/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet13 | routed | - | 192.168.0.125/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet13 | routed | - | 192.168.0.127/31 | default | 1500 | False | - | - |
| Ethernet7 | P2P_LINK_TO_SPINE5_Ethernet13 | routed | - | 192.168.0.129/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_SPINE6_Ethernet13 | routed | - | 192.168.0.131/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_SPINE1_Ethernet13
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_SPINE2_Ethernet13
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description P2P_LINK_TO_SPINE3_Ethernet13
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_SPINE4_Ethernet13
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet7
   description P2P_LINK_TO_SPINE5_Ethernet13
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_LINK_TO_SPINE6_Ethernet13
   no shutdown
   mtu 1500
   no switchport
