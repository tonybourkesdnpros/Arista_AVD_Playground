...
| -------------------- | ----------- | ---- | --- | ---------- | ------- |
| Management0 | oob_management | oob | MGMT | 192.168.0.113 | 192.168.0.1 |
...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet15 | routed | - | 192.168.0.145/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet15 | routed | - | 192.168.0.147/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet15 | routed | - | 192.168.0.149/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet15 | routed | - | 192.168.0.151/31 | default | 1500 | False | - | - |
| Ethernet7 | P2P_LINK_TO_SPINE5_Ethernet15 | routed | - | 192.168.0.153/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_SPINE6_Ethernet15 | routed | - | 192.168.0.155/31 | default | 1500 | False | - | - |
...
!
interface Ethernet3
   description P2P_LINK_TO_SPINE1_Ethernet15
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet4
   description P2P_LINK_TO_SPINE2_Ethernet15
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet5
   description P2P_LINK_TO_SPINE3_Ethernet15
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet6
   description P2P_LINK_TO_SPINE4_Ethernet15
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet7
   description P2P_LINK_TO_SPINE5_Ethernet15
   no shutdown
   mtu 1500
   no switchport
...
!
interface Ethernet8
   description P2P_LINK_TO_SPINE6_Ethernet15
   no shutdown
   mtu 1500
   no switchport
...
| Loopback1 | VTEP_VXLAN_Tunnel_Source | default | 192.168.102.13/32 |
...
| ---- | ------------------- | ----------------- | ------------------- | ------------------- | ------------ |
| 10 | 192.168.101.13:10010 | 10010:10010 | - | - | learned |

#### Router BGP VRFs

| VRF | Route-Distinguisher | Redistribute |
| --- | ------------------- | ------------ |
| VRF_A | 192.168.101.13:10 | connected |
