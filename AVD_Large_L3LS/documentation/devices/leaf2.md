...
| --------- | ----------- | -----| ------------- | ---------- | ----| ---- | -------- | ------ | ------- |
| Ethernet3 | P2P_LINK_TO_SPINE1_Ethernet4 | routed | - | 192.168.0.13/31 | default | 1500 | False | - | - |
| Ethernet4 | P2P_LINK_TO_SPINE2_Ethernet4 | routed | - | 192.168.0.15/31 | default | 1500 | False | - | - |
| Ethernet5 | P2P_LINK_TO_SPINE3_Ethernet4 | routed | - | 192.168.0.17/31 | default | 1500 | False | - | - |
| Ethernet6 | P2P_LINK_TO_SPINE4_Ethernet4 | routed | - | 192.168.0.19/31 | default | 1500 | False | - | - |
| Ethernet8 | P2P_LINK_TO_SPINE6_Ethernet4 | routed | - | 192.168.0.23/31 | default | 1500 | False | - | - |
...
!
interface Ethernet8
   description P2P_LINK_TO_SPINE6_Ethernet4
   no shutdown
   mtu 1500
   no switchport
...
| 192.168.0.12 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.14 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.16 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.18 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.20 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
| 192.168.0.22 | 65001 | default | - | Inherited from peer group IPv4-UNDERLAY-PEERS | Inherited from peer group IPv4-UNDERLAY-PEERS | - | - | - | - | - |
...
router bgp 65100
   ...
   neighbor 192.168.0.12 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.12 remote-as 65001
   neighbor 192.168.0.12 description spine1_Ethernet4
   neighbor 192.168.0.14 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.14 remote-as 65001
   neighbor 192.168.0.14 description spine2_Ethernet4
   neighbor 192.168.0.16 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.16 remote-as 65001
   neighbor 192.168.0.16 description spine3_Ethernet4
   neighbor 192.168.0.18 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.18 remote-as 65001
   neighbor 192.168.0.18 description spine4_Ethernet4
   neighbor 192.168.0.20 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.20 remote-as 65001
   neighbor 192.168.0.20 description spine5_Ethernet4
   neighbor 192.168.0.22 peer group IPv4-UNDERLAY-PEERS
   neighbor 192.168.0.22 remote-as 65001
   neighbor 192.168.0.22 description spine6_Ethernet4
